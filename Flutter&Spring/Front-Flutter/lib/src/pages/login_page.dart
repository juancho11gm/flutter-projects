...
class LoginPage extends StatelessWidget {
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                _createLogInButton('Log in', bloc),
                _createRegisterButton('Register',context),
              ],
            ),
          ),
  ...
  Widget _createLogInButton(String text, LoginBloc bloc) {
    return StreamBuilder(
  ...
  Widget _createRegisterButton(String text, BuildContext context) {
    return Container(
          child: RaisedButton(
            child: Container(
                height: 20.0,
  ...
  _login(LoginBloc bloc, BuildContext context) async{
    ...
    if(info['ok']){
      Navigator.pushReplacementNamed(context, 'basic');
    }else{
